...
def build_m05(out_dir: Path, dormant: bool = False) -> Path:
    ...
    set_vertical_values(
        annual,
        {
            ...
            "agm_time": "",
            "agm_place": "",
            "agm_route": "dormant_company" if dormant else "ordinary_agm",
            "accounts_status": "dormant" if dormant else "unaudited",
            "company_activity_status": "Dormant" if dormant else "Active",
            "acra_dormant_relevant_company": "Yes" if dormant else "Auto",
            "total_assets_under_500k": "Yes" if dormant else "Auto",
            "financial_statements_required": "No" if dormant else "Auto",
            "financial_statements_type": "Dormant no FS" if dormant else "Unaudited",
            "audit_exemption_status": "Dormant relevant" if dormant else "Small company exempt",
